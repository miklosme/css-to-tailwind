...
function normalizer(parsedRules) {
    ...
    const roundResponsiveViewBreakpoints = createRounder({
        breakpoints: getBreakPoints(Object.values(resolvedConfig.theme.screens).sort((a, z) => a - z)),
    });
...
function getVariantFromSelector({ selector, mediaRuleValue, responsiveBreakpointNames, roundResponsiveViewBreakpoints }) {
